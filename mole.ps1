# Mole - System Maintenance Tool for Windows
# Main entry point for Mole on Windows
...
function Show-Help {
    Write-Host ""
    Write-ColorMessage "Mole - System Maintenance Tool for Windows" -Color Magenta
    Write-Host ""
    Write-Host "Usage:"
...
switch ($Command.ToLower()) {
    ...
    "version" {
        Write-ColorMessage "Mole for Windows" -Color Magenta
